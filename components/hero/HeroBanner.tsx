      ...
      <div className="overflow-hidden rounded-2xl border border-border/60 bg-card shadow-xl">
        ...
        <div className="relative px-6 pb-6 pt-0">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4 -mt-16 sm:-mt-20 mb-6">
            {/* Larger Overlapping Avatar */}
            <div className="relative size-32 sm:size-40 rounded-full border-4 border-card bg-card shadow-xl overflow-hidden shrink-0">
              <Image
                src="/avatar.png" 
            ...
            <div className="flex items-center gap-2">
              <Link
                href="#contact"
                className="flex items-center gap-2 rounded-xl bg-foreground px-4 py-2 text-xs sm:text-sm font-semibold text-background transition-all hover:opacity-90 active:scale-95"
              >
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-y-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span className="inline-flex items-center gap-1.5 rounded-lg border border-border/80 bg-muted/60 px-3 py-1.5 text-xs font-semibold text-foreground">
                  <span className="text-blue-500 font-bold">TS</span> TypeScript
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-lg border border-border/80 bg-muted/60 px-3 py-1.5 text-xs font-semibold text-foreground">
                ...
                <span className="inline-flex items-center gap-1.5 rounded-lg border border-border/80 bg-muted/60 px-3 py-1.5 text-xs font-semibold text-foreground">
                  <span className="text-green-500 font-bold">JS</span> Node.js
                </span>
                <span className="inline-flex items-center gap-1.5 rounded-lg border border-border/80 bg-muted/60 px-3 py-1.5 text-xs font-semibold text-foreground">
                  <span className="text-sky-500 font-bold">🐘</span> PostgreSQL
                </span>
              </div>
